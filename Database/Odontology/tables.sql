...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_factura (
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_docidentidad (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_pais (
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_provincia (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_paciente (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_imgdentales (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_comprobante (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_pagos (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.pago_comprobante (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
        id_pago INT,
        id_comprobante INT,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_proveedor (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_umedida (
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_producto (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_stock (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_rrhh (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_cita (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_usomaterial (
        id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_rol (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_usersistema (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_area (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_servicio (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE
    IF NOT EXISTS erp_odonto.erpo_cobros (
        id INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
